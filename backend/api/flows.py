...
async def create_or_update_flow(flow_data: FlowData):
    """
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to store flow: {str(e)}") from e
...
async def list_flows():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to list flows: {str(e)}") from e
