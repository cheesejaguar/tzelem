...
class MailAPITester:
    ...
    def check_mail_health(self) -> dict[str, Any] | None:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                status_color = (
                    Colors.OKGREEN if health.get("status") == "healthy" else Colors.WARNING
                )
                ...
                if not health.get("api_key_configured"):
                    self.print_warning(
                        "AGENTMAIL_API_KEY not configured - tests will run in mock mode"
                    )
            ...
            if response.status_code == expected_status:
                ...
                if expected_response_field and response.status_code == 200:
                    ...
                    if expected_response_field in result:
                        self.print_success(
                            f"Response contains '{expected_response_field}': {result[expected_response_field]}"
                        )
                    else:
    ...
    def run_all_tests(self):
        ...
        self.test_send_email(
            ...
            {"subject": "Missing To Field", "text": "This should fail - no recipient"},
        ...
        self.test_send_email(
            ...
            {"to": "no-subject@tzlm.io", "text": "This should fail - no subject"},
            expected_status=422,  # Validation error
        )
        ...
        self.test_send_email(
            ...
            {"to": "no-content@tzlm.io", "subject": "No Content Test"},
