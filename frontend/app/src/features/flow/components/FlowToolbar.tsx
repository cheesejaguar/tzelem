    ...
    <div className="h-14 flex items-center justify-between px-6 bg-white/95 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <h1 className="text-base font-semibold text-gray-900">Tzelem Flow Builder</h1>
            <div className="flex items-center gap-4 text-sm text-gray-500">
              ...
              {!state.isValid && state.errors.length > 0 && (
                <>
                  <span>•</span>
                  <span className="text-amber-600 font-medium">{state.errors.length} issues</span>
                </>
              )}
            </div>
          </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <Button 
          ...
          size="sm"
          disabled={!state.isValid || state.nodes.length === 0}
        >
